...
def main():
    ...
    # 📂 Bestandspaden
    html_path = r"C:\Users\Rob Vermeer\OneDrive\Documenten\Sports Interactive\Football Manager 2024\8. Python export data\Staff_exports\Staff.html"
    ...
    try:
       ...
       # 🧩 Toevoegen van extra velden
      extra_fields = ["Team", "Job", "Expires", "Naam", "Youth", "Tac Knw", "Judge A", "Judge P", "Media Handling"]
